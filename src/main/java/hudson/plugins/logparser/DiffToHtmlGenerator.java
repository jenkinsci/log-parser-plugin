...
public class DiffToHtmlGenerator {
	...
	public String generateTableRow(String s, int index, int typeNum){
		...
		String res = ""
				...
				+ "<td class='d2h-" + type + "'>\n"
				+ "<div class='d2h-code-side-line d2h-" + type + "' id = 'check-" + type + "'><span class='d2h-code-line-ctn hljs'>" + s + "</span></div>\n"
				+ "</td>\n"
				+ "</tr>\n";
		return res;
	}
	...
	public String generateHead(){
		String res = "<head>\n" + 
		"<meta charset='utf-8'>\n" +
		"<title>line diff between build" + prev + "and build " + curr + "</title>\n" +
	...
	public String generateCSS(){
		String res = ".d2h-wrapper{display:block;margin:0 auto;"
				...
				+ "solid #d8d8d8;background-color:#f7f7f7;font:13px "
				+ "Helvetica,arial,freesans,clean,sans-serif,"
				+ "'Segoe UI Emoji','Segoe UI Symbol'}"
				+ ".d2h-file-name{display:inline;height:33px;"
				+ "line-height:33px;max-width:80%;white-space:nowrap;"
				+ "text-overflow:ellipsis;overflow:hidden}"
				+ ".d2h-diff-table{border-collapse:collapse;"
				...
				+ ".d2h-file-diff{overflow-x:scroll;overflow-y:hidden}"
				+ ".d2h-file-side-diff{display:inline-block;"
				+ "overflow-x:scroll;overflow-y:hidden;width:50%;"
				+ "margin-right:-4px}.d2h-code-side-line{display:block;"
				+ "white-space:pre;padding:0 10px;height:18px;"
				+ "line-height:18px;margin-left:50px;color:inherit;"
				+ "overflow-x:inherit;background:none}.d2h-code-line del,"
				+ ".d2h-code-side-line del{display:inline-block;"
				+ "margin-top:-1px;text-decoration:none;"
				+ "background-color:#ffb6ba;border-radius:.2em}"
				+ ".d2h-code-line ins,.d2h-code-side-line ins"
				+ "{display:inline-block;margin-top:-1px;text-decoration:"
				+ "none;background-color:#97f295;border-radius:.2em}"
				+ ".d2h-code-side-linenumber{position:absolute;"
				...
				+ "border-color:#b4e2b4}.d2h-rev{background-color:#A9F5F2;"
				+ "border-color:#00BFFF}";
