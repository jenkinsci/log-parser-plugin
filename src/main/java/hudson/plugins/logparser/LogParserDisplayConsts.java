...
public class LogParserDisplayConsts {
    ...
    public LogParserDisplayConsts() {
        ...
        colorTable.put(LogParserConsts.PASS, "green");
        ...
        iconTable.put(LogParserConsts.PASS, "green.gif");
        ...
        linkListDisplay.put(LogParserConsts.PASS, "Pass");
        ...
        linkListDisplayPlural.put(LogParserConsts.PASS, "Passes");
